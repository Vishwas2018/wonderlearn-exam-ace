        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-10">
            ...
            >
              ...
              <p className="text-gray-700 mb-4">
                "WonderLearn's practice exams really helped me understand what to expect on test day. The explanations after each question helped me learn from my mistakes."
              </p>
              <div className="flex items-center">
